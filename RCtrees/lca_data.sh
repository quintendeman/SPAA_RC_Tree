...
LD_PRELOAD=$jemellocpath PARLAY_NUM_THREADS=32 ./lca.out -forr -4 -trials 10 -n 10000000 -k 10000000 -mean 40 -ln .9 >> output_lca.csv

for PNT in "${NUM_THREADS[@]}"; do
    LD_PRELOAD=$jemellocpath PARLAY_NUM_THREADS=$PNT ./lca.out -forr -5 -n 10000000 -k 500000 -trials 10 -mean 40 -ln .9 >> output_lca.csv
done
